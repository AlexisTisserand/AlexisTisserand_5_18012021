...
function displayProduct() {
    api.fetchEndPoint(`https://orinoco-p5-alexis-tisserand.herokuapp.com/api/teddies/${productId}`)
        .then(product => {
            console.log(product);
            try {
...
function addToCart() {
    api.fetchEndPoint(`https://orinoco-p5-alexis-tisserand.herokuapp.com/api/teddies/${productId}`)//créer fonction ajouter au panier //http://localhost:3000/api/teddies/
    .then(product => {
        //console.log(product);
        try {
